const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_RICH_INCENSE] = {gItemIcon_WaveIncense, gItemIconPalette_WaveIncense},
    ...
    [ITEM_LINK_CABLE] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark}, // {gItemIcon_LinkCable, gItemIconPalette_LinkCable},
