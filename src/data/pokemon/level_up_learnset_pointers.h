const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
...
#endif
    [SPECIES_ANCHORAGE] = sAnchorageLevelUpLearnset,
    [SPECIES_ANIMON] = sAnimonLevelUpLearnset,
    [SPECIES_AQUARIA] = sAquariaLevelUpLearnset,
    [SPECIES_AQUIS] = sAquisLevelUpLearnset,
    [SPECIES_BELLOYANT] = sBelloyantLevelUpLearnset,
    [SPECIES_BELMITT] = sBelmittLevelUpLearnset,
    [SPECIES_BLOSSOMOLE] = sBlossomoleLevelUpLearnset,
    [SPECIES_BOMSOAKER] = sBomsoakerLevelUpLearnset,
    [SPECIES_CHIKS] = sChiksLevelUpLearnset,
    [SPECIES_COTTONEKO] = sCottonekoLevelUpLearnset,
    [SPECIES_CRUZ] = sCruzLevelUpLearnset,
    [SPECIES_DANDENEKO] = sDandenekoLevelUpLearnset,
    [SPECIES_DYNABEAR] = sDynabearLevelUpLearnset,
    [SPECIES_FLAMBEAR] = sFlambearLevelUpLearnset,
    [SPECIES_GOHNG] = sGohngLevelUpLearnset,
    [SPECIES_GOLPY] = sGolpyLevelUpLearnset,
    [SPECIES_GRIMEY] = sGrimeyLevelUpLearnset,
    [SPECIES_GROTESS] = sGrotessLevelUpLearnset,
    [SPECIES_KOTORA] = sKotoraLevelUpLearnset,
    [SPECIES_KURSTRAW] = sKurstrawLevelUpLearnset,
    [SPECIES_LEFNEKO] = sLefnekoLevelUpLearnset,
    ...
    [SPECIES_OWLDURN] = sOwldurnLevelUpLearnset,
    [SPECIES_PANGSHI] = sPangshiLevelUpLearnset,
    [SPECIES_PARA] = sParaLevelUpLearnset,
    [SPECIES_PLUX] = sPluxLevelUpLearnset,
    [SPECIES_PORYGON_C] = sPorygon_CLevelUpLearnset,
    [SPECIES_PUDDI] = sPuddiLevelUpLearnset,
    [SPECIES_RAITORA] = sRaitoraLevelUpLearnset,
    [SPECIES_RAYLEEP] = sRayleepLevelUpLearnset,
    [SPECIES_RINRING] = sRinringLevelUpLearnset,
    [SPECIES_SUNMOLA] = sSunmolaLevelUpLearnset,
    [SPECIES_SWIEVEL] = sSwievelLevelUpLearnset,
    [SPECIES_TANGEL] = sTangelLevelUpLearnset,
    [SPECIES_TANGRATH] = sTangrathLevelUpLearnset,
    [SPECIES_TRIFOX] = sTrifoxLevelUpLearnset,
    [SPECIES_TURBANN] = sTurbannLevelUpLearnset,
    [SPECIES_TWINZ] = sTwinzLevelUpLearnset,
    [SPECIES_VOLBEAR] = sVolbearLevelUpLearnset,
    [SPECIES_WARWOLF] = sWarwolfLevelUpLearnset,
    [SPECIES_WHIMSEY] = sWhimseyLevelUpLearnset,
    [SPECIES_WOLFMAN] = sWolfmanLevelUpLearnset,
    [SPECIES_x_AZUMARILL_x] = sx_Azumarill_xLevelUpLearnset,
    [SPECIES_x_CELEBI_x] = sx_Celebi_xLevelUpLearnset,
    [SPECIES_x_DUNSPARCE_x] = sx_Dunsparce_xLevelUpLearnset,
    [SPECIES_x_GLIGAR_x] = sx_Gligar_xLevelUpLearnset,
    [SPECIES_x_WOOPER_x] = sx_Wooper_xLevelUpLearnset,
};
