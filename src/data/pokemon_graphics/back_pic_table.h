...
#endif
    SPECIES_SPRITE(ANCHORAGE, gMonBackPic_Anchorage),
    SPECIES_SPRITE(ANIMON, gMonBackPic_Animon),
    SPECIES_SPRITE(AQUARIA, gMonBackPic_Aquaria),
    SPECIES_SPRITE(AQUIS, gMonBackPic_Aquis),
    SPECIES_SPRITE(BELLOYANT, gMonBackPic_Belloyant),
    SPECIES_SPRITE(BELMITT, gMonBackPic_Belmitt),
    SPECIES_SPRITE(BLOSSOMOLE, gMonBackPic_Blossomole),
    SPECIES_SPRITE(BOMSOAKER, gMonBackPic_Bomsoaker),
    SPECIES_SPRITE(CHIKS, gMonBackPic_Chiks),
    SPECIES_SPRITE(COTTONEKO, gMonBackPic_Cottoneko),
    SPECIES_SPRITE(CRUZ, gMonBackPic_Cruz),
    SPECIES_SPRITE(DANDENEKO, gMonBackPic_Dandeneko),
    SPECIES_SPRITE(DYNABEAR, gMonBackPic_Dynabear),
    SPECIES_SPRITE(FLAMBEAR, gMonBackPic_Flambear),
    SPECIES_SPRITE(GOHNG, gMonBackPic_Gohng),
    SPECIES_SPRITE(GOLPY, gMonBackPic_Golpy),
    SPECIES_SPRITE(GRIMEY, gMonBackPic_Grimey),
    SPECIES_SPRITE(GROTESS, gMonBackPic_Grotess),
    SPECIES_SPRITE(KOTORA, gMonBackPic_Kotora),
    SPECIES_SPRITE(KURSTRAW, gMonBackPic_Kurstraw),
    SPECIES_SPRITE(LEFNEKO, gMonBackPic_Lefneko),
    SPECIES_SPRITE(MADAME, gMonBackPic_Madame),
    SPECIES_SPRITE(MEOWSY, gMonBackPic_Meowsy),
    SPECIES_SPRITE(MINICORN, gMonBackPic_Minicorn),
    SPECIES_SPRITE(NUMPUFF, gMonBackPic_Numpuff),
    SPECIES_SPRITE(OWLDURN, gMonBackPic_Owldurn),
    SPECIES_SPRITE(PANGSHI, gMonBackPic_Pangshi),
    SPECIES_SPRITE(PARA, gMonBackPic_Para),
    SPECIES_SPRITE(PLUX, gMonBackPic_Plux),
    SPECIES_SPRITE(PORYGON_C, gMonBackPic_Porygon_C),
    SPECIES_SPRITE(PUDDI, gMonBackPic_Puddi),
    SPECIES_SPRITE(RAITORA, gMonBackPic_Raitora),
    SPECIES_SPRITE(RAYLEEP, gMonBackPic_Rayleep),
    SPECIES_SPRITE(RINRING, gMonBackPic_Rinring),
    SPECIES_SPRITE(SUNMOLA, gMonBackPic_Sunmola),
    SPECIES_SPRITE(SWIEVEL, gMonBackPic_Swievel),
    SPECIES_SPRITE(TANGEL, gMonBackPic_Tangel),
    SPECIES_SPRITE(TANGRATH, gMonBackPic_Tangrath),
    SPECIES_SPRITE(TRIFOX, gMonBackPic_Trifox),
    SPECIES_SPRITE(TURBANN, gMonBackPic_Turbann),
    SPECIES_SPRITE(TWINZ, gMonBackPic_Twinz),
    SPECIES_SPRITE(VOLBEAR, gMonBackPic_Volbear),
    SPECIES_SPRITE(WARWOLF, gMonBackPic_Warwolf),
    SPECIES_SPRITE(WHIMSEY, gMonBackPic_Whimsey),
    SPECIES_SPRITE(WOLFMAN, gMonBackPic_Wolfman),
    SPECIES_SPRITE(x_AZUMARILL_x, gMonBackPic_x_Azumarill_x),
    SPECIES_SPRITE(x_CELEBI_x, gMonBackPic_x_Celebi_x),
    SPECIES_SPRITE(x_DUNSPARCE_x, gMonBackPic_x_Dunsparce_x),
    SPECIES_SPRITE(x_GLIGAR_x, gMonBackPic_x_Gligar_x),
    SPECIES_SPRITE(x_WOOPER_x, gMonBackPic_x_Wooper_x),
