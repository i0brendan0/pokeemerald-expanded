const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_ANIMON] = gMonFootprint_Animon,
    [SPECIES_AQUARIA] = gMonFootprint_Aquaria,
    [SPECIES_AQUIS] = gMonFootprint_Aquis,
    [SPECIES_BELLOYANT] = gMonFootprint_Belloyant,
    [SPECIES_BELMITT] = gMonFootprint_Belmitt,
    [SPECIES_BLOSSOMOLE] = gMonFootprint_Blossomole,
    [SPECIES_BOMSOAKER] = gMonFootprint_Bomsoaker,
    [SPECIES_CHIKS] = gMonFootprint_Chiks,
    [SPECIES_COTTONEKO] = gMonFootprint_Cottoneko,
    [SPECIES_CRUZ] = gMonFootprint_Cruz,
    [SPECIES_DANDENEKO] = gMonFootprint_Dandeneko,
    [SPECIES_DYNABEAR] = gMonFootprint_Dynabear,
    [SPECIES_FLAMBEAR] = gMonFootprint_Flambear,
    [SPECIES_GOHNG] = gMonFootprint_Gohng,
    [SPECIES_GOLPY] = gMonFootprint_Golpy,
    [SPECIES_GRIMEY] = gMonFootprint_Grimey,
    [SPECIES_GROTESS] = gMonFootprint_Grotess,
    [SPECIES_KOTORA] = gMonFootprint_Kotora,
    [SPECIES_KURSTRAW] = gMonFootprint_Kurstraw,
    [SPECIES_LEFNEKO] = gMonFootprint_Lefneko,
    [SPECIES_MADAME] = gMonFootprint_Madame,
    [SPECIES_MEOWSY] = gMonFootprint_Meowsy,
    [SPECIES_MINICORN] = gMonFootprint_Minicorn,
    [SPECIES_NUMPUFF] = gMonFootprint_Numpuff,
    [SPECIES_OWLDURN] = gMonFootprint_Owldurn,
    [SPECIES_PANGSHI] = gMonFootprint_Pangshi,
    [SPECIES_PARA] = gMonFootprint_Para,
    [SPECIES_PLUX] = gMonFootprint_Plux,
    [SPECIES_PORYGON_C] = gMonFootprint_Porygon_C,
    [SPECIES_PUDDI] = gMonFootprint_Puddi,
    [SPECIES_RAITORA] = gMonFootprint_Raitora,
    [SPECIES_RAYLEEP] = gMonFootprint_Rayleep,
    [SPECIES_RINRING] = gMonFootprint_Rinring,
    [SPECIES_SUNMOLA] = gMonFootprint_Sunmola,
    [SPECIES_SWIEVEL] = gMonFootprint_Swievel,
    [SPECIES_TANGEL] = gMonFootprint_Tangel,
    [SPECIES_TANGRATH] = gMonFootprint_Tangrath,
    [SPECIES_TRIFOX] = gMonFootprint_Trifox,
    [SPECIES_TURBANN] = gMonFootprint_Turbann,
    [SPECIES_TWINZ] = gMonFootprint_Twinz,
    [SPECIES_VOLBEAR] = gMonFootprint_Volbear,
    [SPECIES_WARWOLF] = gMonFootprint_Warwolf,
    [SPECIES_WHIMSEY] = gMonFootprint_Whimsey,
    [SPECIES_WOLFMAN] = gMonFootprint_Wolfman,
    [SPECIES_x_AZUMARILL_x] = gMonFootprint_x_Azumarill_x,
    [SPECIES_x_CELEBI_x] = gMonFootprint_x_Celebi_x,
    [SPECIES_x_DUNSPARCE_x] = gMonFootprint_x_Dunsparce_x,
    [SPECIES_x_GLIGAR_x] = gMonFootprint_x_Gligar_x,
    [SPECIES_x_WOOPER_x] = gMonFootprint_x_Wooper_x,
