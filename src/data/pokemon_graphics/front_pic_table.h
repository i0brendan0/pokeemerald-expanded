const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(ANIMON, gMonFrontPic_Animon),
    SPECIES_SPRITE(AQUARIA, gMonFrontPic_Aquaria),
    SPECIES_SPRITE(AQUIS, gMonFrontPic_Aquis),
    SPECIES_SPRITE(BELLOYANT, gMonFrontPic_Belloyant),
    SPECIES_SPRITE(BELMITT, gMonFrontPic_Belmitt),
    SPECIES_SPRITE(BLOSSOMOLE, gMonFrontPic_Blossomole),
    SPECIES_SPRITE(BOMSOAKER, gMonFrontPic_Bomsoaker),
    SPECIES_SPRITE(CHIKS, gMonFrontPic_Chiks),
    SPECIES_SPRITE(COTTONEKO, gMonFrontPic_Cottoneko),
    SPECIES_SPRITE(CRUZ, gMonFrontPic_Cruz),
    SPECIES_SPRITE(DANDENEKO, gMonFrontPic_Dandeneko),
    SPECIES_SPRITE(DYNABEAR, gMonFrontPic_Dynabear),
    SPECIES_SPRITE(FLAMBEAR, gMonFrontPic_Flambear),
    SPECIES_SPRITE(GOHNG, gMonFrontPic_Gohng),
    SPECIES_SPRITE(GOLPY, gMonFrontPic_Golpy),
    SPECIES_SPRITE(GRIMEY, gMonFrontPic_Grimey),
    SPECIES_SPRITE(GROTESS, gMonFrontPic_Grotess),
    SPECIES_SPRITE(KOTORA, gMonFrontPic_Kotora),
    SPECIES_SPRITE(KURSTRAW, gMonFrontPic_Kurstraw),
    SPECIES_SPRITE(LEFNEKO, gMonFrontPic_Lefneko),
    SPECIES_SPRITE(MADAME, gMonFrontPic_Madame),
    SPECIES_SPRITE(MEOWSY, gMonFrontPic_Meowsy),
    SPECIES_SPRITE(MINICORN, gMonFrontPic_Minicorn),
    SPECIES_SPRITE(NUMPUFF, gMonFrontPic_Numpuff),
    SPECIES_SPRITE(OWLDURN, gMonFrontPic_Owldurn),
    SPECIES_SPRITE(PANGSHI, gMonFrontPic_Pangshi),
    SPECIES_SPRITE(PARA, gMonFrontPic_Para),
    SPECIES_SPRITE(PLUX, gMonFrontPic_Plux),
    SPECIES_SPRITE(PORYGON_C, gMonFrontPic_Porygon_C),
    SPECIES_SPRITE(PUDDI, gMonFrontPic_Puddi),
    SPECIES_SPRITE(RAITORA, gMonFrontPic_Raitora),
    SPECIES_SPRITE(RAYLEEP, gMonFrontPic_Rayleep),
    SPECIES_SPRITE(RINRING, gMonFrontPic_Rinring),
    SPECIES_SPRITE(SUNMOLA, gMonFrontPic_Sunmola),
    SPECIES_SPRITE(SWIEVEL, gMonFrontPic_Swievel),
    SPECIES_SPRITE(TANGEL, gMonFrontPic_Tangel),
    SPECIES_SPRITE(TANGRATH, gMonFrontPic_Tangrath),
    SPECIES_SPRITE(TRIFOX, gMonFrontPic_Trifox),
    SPECIES_SPRITE(TURBANN, gMonFrontPic_Turbann),
    SPECIES_SPRITE(TWINZ, gMonFrontPic_Twinz),
    SPECIES_SPRITE(VOLBEAR, gMonFrontPic_Volbear),
    SPECIES_SPRITE(WARWOLF, gMonFrontPic_Warwolf),
    SPECIES_SPRITE(WHIMSEY, gMonFrontPic_Whimsey),
    SPECIES_SPRITE(WOLFMAN, gMonFrontPic_Wolfman),
    SPECIES_SPRITE(x_AZUMARILL_x, gMonFrontPic_x_Azumarill_x),
    SPECIES_SPRITE(x_CELEBI_x, gMonFrontPic_x_Celebi_x),
    SPECIES_SPRITE(x_DUNSPARCE_x, gMonFrontPic_x_Dunsparce_x),
    SPECIES_SPRITE(x_GLIGAR_x, gMonFrontPic_x_Gligar_x),
    SPECIES_SPRITE(x_WOOPER_x, gMonFrontPic_x_Wooper_x),
