const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(ANIMON, gMonPalette_Animon),
    SPECIES_PAL(AQUARIA, gMonPalette_Aquaria),
    SPECIES_PAL(AQUIS, gMonPalette_Aquis),
    SPECIES_PAL(BELLOYANT, gMonPalette_Belloyant),
    SPECIES_PAL(BELMITT, gMonPalette_Belmitt),
    SPECIES_PAL(BLOSSOMOLE, gMonPalette_Blossomole),
    SPECIES_PAL(BOMSOAKER, gMonPalette_Bomsoaker),
    SPECIES_PAL(CHIKS, gMonPalette_Chiks),
    SPECIES_PAL(COTTONEKO, gMonPalette_Cottoneko),
    SPECIES_PAL(CRUZ, gMonPalette_Cruz),
    SPECIES_PAL(DANDENEKO, gMonPalette_Dandeneko),
    SPECIES_PAL(DYNABEAR, gMonPalette_Dynabear),
    SPECIES_PAL(FLAMBEAR, gMonPalette_Flambear),
    SPECIES_PAL(GOHNG, gMonPalette_Gohng),
    SPECIES_PAL(GOLPY, gMonPalette_Golpy),
    SPECIES_PAL(GRIMEY, gMonPalette_Grimey),
    SPECIES_PAL(GROTESS, gMonPalette_Grotess),
    SPECIES_PAL(KOTORA, gMonPalette_Kotora),
    SPECIES_PAL(KURSTRAW, gMonPalette_Kurstraw),
    SPECIES_PAL(LEFNEKO, gMonPalette_Lefneko),
    SPECIES_PAL(MADAME, gMonPalette_Madame),
    SPECIES_PAL(MEOWSY, gMonPalette_Meowsy),
    SPECIES_PAL(MINICORN, gMonPalette_Minicorn),
    SPECIES_PAL(NUMPUFF, gMonPalette_Numpuff),
    SPECIES_PAL(OWLDURN, gMonPalette_Owldurn),
    SPECIES_PAL(PANGSHI, gMonPalette_Pangshi),
    SPECIES_PAL(PARA, gMonPalette_Para),
    SPECIES_PAL(PLUX, gMonPalette_Plux),
    SPECIES_PAL(PORYGON_C, gMonPalette_Porygon_C),
    SPECIES_PAL(PUDDI, gMonPalette_Puddi),
    SPECIES_PAL(RAITORA, gMonPalette_Raitora),
    SPECIES_PAL(RAYLEEP, gMonPalette_Rayleep),
    SPECIES_PAL(RINRING, gMonPalette_Rinring),
    SPECIES_PAL(SUNMOLA, gMonPalette_Sunmola),
    SPECIES_PAL(SWIEVEL, gMonPalette_Swievel),
    SPECIES_PAL(TANGEL, gMonPalette_Tangel),
    SPECIES_PAL(TANGRATH, gMonPalette_Tangrath),
    SPECIES_PAL(TRIFOX, gMonPalette_Trifox),
    SPECIES_PAL(TURBANN, gMonPalette_Turbann),
    SPECIES_PAL(TWINZ, gMonPalette_Twinz),
    SPECIES_PAL(VOLBEAR, gMonPalette_Volbear),
    SPECIES_PAL(WARWOLF, gMonPalette_Warwolf),
    SPECIES_PAL(WHIMSEY, gMonPalette_Whimsey),
    SPECIES_PAL(WOLFMAN, gMonPalette_Wolfman),
    SPECIES_PAL(x_AZUMARILL_x, gMonPalette_x_Azumarill_x),
    SPECIES_PAL(x_CELEBI_x, gMonPalette_x_Celebi_x),
    SPECIES_PAL(x_DUNSPARCE_x, gMonPalette_x_Dunsparce_x),
    SPECIES_PAL(x_GLIGAR_x, gMonPalette_x_Gligar_x),
    SPECIES_PAL(x_WOOPER_x, gMonPalette_x_Wooper_x),
