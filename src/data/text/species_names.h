const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_x_AZUMARILL_x] = _("x-Azuma-x"),
    [SPECIES_x_CELEBI_x] = _("x-Celebi-x"),
    [SPECIES_x_DUNSPARCE_x] = _("x-Dunspa-x"),
    [SPECIES_x_GLIGAR_x] = _("x-Gligar-x"),
    [SPECIES_x_WOOPER_x] = _("x-Wooper-x"),
