const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_ANIMON] = _("Animon"),
    [SPECIES_AQUARIA] = _("Aquaria"),
    [SPECIES_AQUIS] = _("Aquis"),
    [SPECIES_BELLOYANT] = _("Belloyant"),
    [SPECIES_BELMITT] = _("Belmitt"),
    [SPECIES_BLOSSOMOLE] = _("Blossomole"),
    [SPECIES_BOMSOAKER] = _("Bomsoaker"),
    [SPECIES_CHIKS] = _("Chiks"),
    [SPECIES_COTTONEKO] = _("Cottoneko"),
    [SPECIES_CRUZ] = _("Cruz"),
    [SPECIES_DANDENEKO] = _("Dandeneko"),
    [SPECIES_DYNABEAR] = _("Dynabear"),
    [SPECIES_FLAMBEAR] = _("Flambear"),
    [SPECIES_GOHNG] = _("Gohng"),
    [SPECIES_GOLPY] = _("Golpy"),
    [SPECIES_GRIMEY] = _("Grimey"),
    [SPECIES_GROTESS] = _("Grotess"),
    [SPECIES_KOTORA] = _("Kotora"),
    [SPECIES_KURSTRAW] = _("Kurstraw"),
    [SPECIES_LEFNEKO] = _("Lefneko"),
    [SPECIES_MADAME] = _("Madame"),
    [SPECIES_MEOWSY] = _("Meowsy"),
    [SPECIES_MINICORN] = _("Minicorn"),
    [SPECIES_NUMPUFF] = _("Numpuff"),
    [SPECIES_OWLDURN] = _("Owldurn"),
    [SPECIES_PANGSHI] = _("Pangshi"),
    [SPECIES_PARA] = _("Para"),
    [SPECIES_PLUX] = _("Plux"),
    [SPECIES_PORYGON_C] = _("Porygon-C"),
    [SPECIES_PUDDI] = _("Puddi"),
    [SPECIES_RAITORA] = _("Raitora"),
    [SPECIES_RAYLEEP] = _("Rayleep"),
    [SPECIES_RINRING] = _("Rinring"),
    [SPECIES_SUNMOLA] = _("Sunmola"),
    [SPECIES_SWIEVEL] = _("Swievel"),
    [SPECIES_TANGEL] = _("Tangel"),
    [SPECIES_TANGRATH] = _("Tangrath"),
    [SPECIES_TRIFOX] = _("Trifox"),
    [SPECIES_TURBANN] = _("Turbann"),
    [SPECIES_TWINZ] = _("Twinz"),
    [SPECIES_VOLBEAR] = _("Volbear"),
    [SPECIES_WARWOLF] = _("Warwolf"),
    [SPECIES_WHIMSEY] = _("Whimsey"),
    [SPECIES_WOLFMAN] = _("Wolfman"),
    [SPECIES_x_AZUMARILL_x] = _("Kirorill"),
    [SPECIES_x_CELEBI_x] = _("XX-0000"),
    [SPECIES_x_DUNSPARCE_x] = _("Duneslet"),
    [SPECIES_x_GLIGAR_x] = _("Stingbat"),
    [SPECIES_x_WOOPER_x] = _("Woober"),
