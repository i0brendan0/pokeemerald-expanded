...
//    { SPECIES_x_DUNSPARCE_x, ITEM_NONE_INCENSE,  SPECIES_DUNSPARCE },
};
...
static const struct {
  ...
  u16 item;
  u16 move;
} BreedingSpecialMoveItemTable[][3] = // XMODIFYX
{
    // Offspring,        Item,             Move
