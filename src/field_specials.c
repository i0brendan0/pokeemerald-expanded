...
static void TryGiveRandomEgg(void);
...
{
    if (gSaveBlock2Ptr->rivalGender == FEMALE)
...
void TryChangeDeoxysForm(void)
{
     ...
     || baseSpecies == SPECIES_DEOXYS_SPEED)
    {
        ...
        {
            case MB_CHANGE_FORM_DEOXYS_NORMAL:
                targetSpecies = SPECIES_DEOXYS;
                break;
            case MB_CHANGE_FORM_DEOXYS_ATTACK:
                targetSpecies = SPECIES_DEOXYS_ATTACK;
                break;
            case MB_CHANGE_FORM_DEOXYS_DEFENSE:
                targetSpecies = SPECIES_DEOXYS_DEFENSE;
                break;
            case MB_CHANGE_FORM_DEOXYS_SPEED:
