...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(x_AZUMARILL_x),
    ...
    SPECIES_TO_HOENN(RINRING),
    SPECIES_TO_HOENN(BELLOYANT),
    ...
    SPECIES_TO_HOENN(LEFNEKO),
    SPECIES_TO_HOENN(DANDENEKO),
    SPECIES_TO_HOENN(COTTONEKO),
    SPECIES_TO_HOENN(FLAMBEAR),
    SPECIES_TO_HOENN(VOLBEAR),
    SPECIES_TO_HOENN(DYNABEAR),
    SPECIES_TO_HOENN(CRUZ),
    SPECIES_TO_HOENN(AQUIS),
    SPECIES_TO_HOENN(AQUARIA),
    SPECIES_TO_HOENN(KURSTRAW),
    SPECIES_TO_HOENN(PANGSHI),
    SPECIES_TO_HOENN(BOMSOAKER),
    SPECIES_TO_HOENN(WOLFMAN),
    SPECIES_TO_HOENN(WARWOLF),
    SPECIES_TO_HOENN(TWINZ),
    SPECIES_TO_HOENN(KOTORA),
    SPECIES_TO_HOENN(RAITORA),
    SPECIES_TO_HOENN(SWIEVEL),
    SPECIES_TO_HOENN(x_CELEBI_x),
};
...
#endif
    SPECIES_TO_NATIONAL(ANCHORAGE),
    SPECIES_TO_NATIONAL(ANIMON),
    SPECIES_TO_NATIONAL(AQUARIA),
    SPECIES_TO_NATIONAL(AQUIS),
    SPECIES_TO_NATIONAL(BELLOYANT),
    SPECIES_TO_NATIONAL(BELMITT),
    SPECIES_TO_NATIONAL(BLOSSOMOLE),
    SPECIES_TO_NATIONAL(BOMSOAKER),
    SPECIES_TO_NATIONAL(CHIKS),
    SPECIES_TO_NATIONAL(COTTONEKO),
    SPECIES_TO_NATIONAL(CRUZ),
    SPECIES_TO_NATIONAL(DANDENEKO),
    SPECIES_TO_NATIONAL(DYNABEAR),
    SPECIES_TO_NATIONAL(FLAMBEAR),
    SPECIES_TO_NATIONAL(GOHNG),
    SPECIES_TO_NATIONAL(GOLPY),
    SPECIES_TO_NATIONAL(GRIMEY),
    SPECIES_TO_NATIONAL(GROTESS),
    SPECIES_TO_NATIONAL(KOTORA),
    SPECIES_TO_NATIONAL(KURSTRAW),
    SPECIES_TO_NATIONAL(LEFNEKO),
    SPECIES_TO_NATIONAL(MADAME),
    SPECIES_TO_NATIONAL(MEOWSY),
    SPECIES_TO_NATIONAL(MINICORN),
    SPECIES_TO_NATIONAL(NUMPUFF),
    SPECIES_TO_NATIONAL(OWLDURN),
    SPECIES_TO_NATIONAL(PANGSHI),
    SPECIES_TO_NATIONAL(PARA),
    SPECIES_TO_NATIONAL(PLUX),
    SPECIES_TO_NATIONAL(PORYGON_C),
    SPECIES_TO_NATIONAL(PUDDI),
    SPECIES_TO_NATIONAL(RAITORA),
    SPECIES_TO_NATIONAL(RAYLEEP),
    SPECIES_TO_NATIONAL(RINRING),
    SPECIES_TO_NATIONAL(SUNMOLA),
    SPECIES_TO_NATIONAL(SWIEVEL),
    SPECIES_TO_NATIONAL(TANGEL),
    SPECIES_TO_NATIONAL(TANGRATH),
    SPECIES_TO_NATIONAL(TRIFOX),
    SPECIES_TO_NATIONAL(TURBANN),
    SPECIES_TO_NATIONAL(TWINZ),
    SPECIES_TO_NATIONAL(VOLBEAR),
    SPECIES_TO_NATIONAL(WARWOLF),
    SPECIES_TO_NATIONAL(WHIMSEY),
    SPECIES_TO_NATIONAL(WOLFMAN),
    SPECIES_TO_NATIONAL(x_AZUMARILL_x),
    SPECIES_TO_NATIONAL(x_CELEBI_x),
    SPECIES_TO_NATIONAL(x_DUNSPARCE_x),
    SPECIES_TO_NATIONAL(x_GLIGAR_x),
    SPECIES_TO_NATIONAL(x_WOOPER_x),
...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(x_AZUMARILL_x),
    ...
    HOENN_TO_NATIONAL(RINRING),
    HOENN_TO_NATIONAL(BELLOYANT),
    ...
    HOENN_TO_NATIONAL(LEFNEKO),
    HOENN_TO_NATIONAL(DANDENEKO),
    HOENN_TO_NATIONAL(COTTONEKO),
    HOENN_TO_NATIONAL(FLAMBEAR),
    HOENN_TO_NATIONAL(VOLBEAR),
    HOENN_TO_NATIONAL(DYNABEAR),
    HOENN_TO_NATIONAL(CRUZ),
    HOENN_TO_NATIONAL(AQUIS),
    HOENN_TO_NATIONAL(AQUARIA),
    HOENN_TO_NATIONAL(KURSTRAW),
    HOENN_TO_NATIONAL(PANGSHI),
    HOENN_TO_NATIONAL(BOMSOAKER),
    HOENN_TO_NATIONAL(WOLFMAN),
    HOENN_TO_NATIONAL(WARWOLF),
    HOENN_TO_NATIONAL(TWINZ),
    HOENN_TO_NATIONAL(KOTORA),
    HOENN_TO_NATIONAL(RAITORA),
    HOENN_TO_NATIONAL(SWIEVEL),
    HOENN_TO_NATIONAL(x_CELEBI_x),
};
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_ANCHORAGE - 1]     = ANIM_V_JUMPS_SMALL,
    [SPECIES_ANIMON - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_AQUARIA - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_AQUIS - 1]         = ANIM_V_JUMPS_SMALL,
    [SPECIES_BELLOYANT - 1]     = ANIM_V_JUMPS_SMALL,
    [SPECIES_BELMITT - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_BLOSSOMOLE - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_BOMSOAKER - 1]     = ANIM_V_JUMPS_SMALL,
    [SPECIES_CHIKS - 1]         = ANIM_V_JUMPS_SMALL,
    [SPECIES_COTTONEKO - 1]     = ANIM_V_JUMPS_SMALL,
    [SPECIES_CRUZ - 1]          = ANIM_V_JUMPS_SMALL,
    [SPECIES_DANDENEKO - 1]     = ANIM_V_JUMPS_SMALL,
    [SPECIES_DYNABEAR - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_FLAMBEAR - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_GOHNG - 1]         = ANIM_V_JUMPS_SMALL,
    [SPECIES_GOLPY - 1]         = ANIM_V_JUMPS_SMALL,
    [SPECIES_GRIMEY - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_GROTESS - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_KOTORA - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_KURSTRAW - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_LEFNEKO - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_MADAME - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_MEOWSY - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_MINICORN - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_NUMPUFF - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_OWLDURN - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_PANGSHI - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_PARA - 1]          = ANIM_V_JUMPS_SMALL,
    [SPECIES_PLUX - 1]          = ANIM_V_JUMPS_SMALL,
    [SPECIES_PORYGON_C - 1]     = ANIM_V_JUMPS_SMALL,
    [SPECIES_PUDDI - 1]         = ANIM_V_JUMPS_SMALL,
    [SPECIES_RAITORA - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_RAYLEEP - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_RINRING - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_SUNMOLA - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_SWIEVEL - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_TANGEL - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_TANGRATH - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_TRIFOX - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_TURBANN - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_TWINZ - 1]         = ANIM_V_JUMPS_SMALL,
    [SPECIES_VOLBEAR - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_WARWOLF - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_WHIMSEY - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_WOLFMAN - 1]       = ANIM_V_JUMPS_SMALL,
    [SPECIES_x_AZUMARILL_x - 1] = ANIM_V_JUMPS_SMALL,
    [SPECIES_x_CELEBI_x - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_x_DUNSPARCE_x - 1] = ANIM_V_JUMPS_SMALL,
    [SPECIES_x_GLIGAR_x - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_x_WOOPER_x - 1]    = ANIM_V_JUMPS_SMALL,
};
...
u16 GetEvolutionTargetSpecies(struct Pokemon *mon, u8 mode, u16 evolutionItem, struct Pokemon *tradePartner)
{
    ...
    case EVO_MODE_NORMAL:
        ...
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            {
            case EVO_FRIENDSHIP:
                if (friendship >= FRIENSHIP_TO_EVOLVE)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            case EVO_FRIENDSHIP_DAY:
                RtcCalcLocalTime();
                if (gLocalTime.hours >= 12 && gLocalTime.hours < 24 && friendship >= FRIENSHIP_TO_EVOLVE)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            case EVO_LEVEL_DAY:
                RtcCalcLocalTime();
            ...
            case EVO_FRIENDSHIP_NIGHT:
                RtcCalcLocalTime();
                if (gLocalTime.hours >= 0 && gLocalTime.hours < 12 && friendship >= FRIENSHIP_TO_EVOLVE)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
