...
#endif
    [SPECIES_ANCHORAGE] = gMonIcon_Anchorage,
    [SPECIES_ANIMON] = gMonIcon_Animon,
    [SPECIES_AQUARIA] = gMonIcon_Aquaria,
    [SPECIES_AQUIS] = gMonIcon_Aquis,
    [SPECIES_BELLOYANT] = gMonIcon_Belloyant,
    [SPECIES_BELMITT] = gMonIcon_Belmitt,
    [SPECIES_BLOSSOMOLE] = gMonIcon_Blossomole,
    [SPECIES_BOMSOAKER] = gMonIcon_Bomsoaker,
    [SPECIES_CHIKS] = gMonIcon_Chiks,
    [SPECIES_COTTONEKO] = gMonIcon_Cottoneko,
    [SPECIES_CRUZ] = gMonIcon_Cruz,
    [SPECIES_DANDENEKO] = gMonIcon_Dandeneko,
    [SPECIES_DYNABEAR] = gMonIcon_Dynabear,
    [SPECIES_FLAMBEAR] = gMonIcon_Flambear,
    [SPECIES_GOHNG] = gMonIcon_Gohng,
    [SPECIES_GOLPY] = gMonIcon_Golpy,
    [SPECIES_GRIMEY] = gMonIcon_Grimey,
    [SPECIES_GROTESS] = gMonIcon_Grotess,
    [SPECIES_KOTORA] = gMonIcon_Kotora,
    [SPECIES_KURSTRAW] = gMonIcon_Kurstraw,
    [SPECIES_LEFNEKO] = gMonIcon_Lefneko,
    [SPECIES_MADAME] = gMonIcon_Madame,
    [SPECIES_MEOWSY] = gMonIcon_Meowsy,
    [SPECIES_MINICORN] = gMonIcon_Minicorn,
    [SPECIES_NUMPUFF] = gMonIcon_Numpuff,
    [SPECIES_OWLDURN] = gMonIcon_Owldurn,
    [SPECIES_PANGSHI] = gMonIcon_Pangshi,
    [SPECIES_PARA] = gMonIcon_Para,
    [SPECIES_PLUX] = gMonIcon_Plux,
    [SPECIES_PORYGON_C] = gMonIcon_Porygon_C,
    [SPECIES_PUDDI] = gMonIcon_Puddi,
    [SPECIES_RAITORA] = gMonIcon_Raitora,
    [SPECIES_RAYLEEP] = gMonIcon_Rayleep,
    [SPECIES_RINRING] = gMonIcon_Rinring,
    [SPECIES_SUNMOLA] = gMonIcon_Sunmola,
    [SPECIES_SWIEVEL] = gMonIcon_Swievel,
    [SPECIES_TANGEL] = gMonIcon_Tangel,
    [SPECIES_TANGRATH] = gMonIcon_Tangrath,
    [SPECIES_TRIFOX] = gMonIcon_Trifox,
    [SPECIES_TURBANN] = gMonIcon_Turbann,
    [SPECIES_TWINZ] = gMonIcon_Twinz,
    [SPECIES_VOLBEAR] = gMonIcon_Volbear,
    [SPECIES_WARWOLF] = gMonIcon_Warwolf,
    [SPECIES_WHIMSEY] = gMonIcon_Whimsey,
    [SPECIES_WOLFMAN] = gMonIcon_Wolfman,
    [SPECIES_x_AZUMARILL_x] = gMonIcon_x_Azumarill_x,
    [SPECIES_x_CELEBI_x] = gMonIcon_x_Celebi_x,
    [SPECIES_x_DUNSPARCE_x] = gMonIcon_x_Dunsparce_x,
    [SPECIES_x_GLIGAR_x] = gMonIcon_x_Gligar_x,
    [SPECIES_x_WOOPER_x] = gMonIcon_x_Wooper_x,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_WHIMSEY] = 0,
    [SPECIES_WOLFMAN] = 0,
    [SPECIES_x_AZUMARILL_x] = 0,
    [SPECIES_x_CELEBI_x] = 0,
    [SPECIES_x_DUNSPARCE_x] = 0,
    [SPECIES_x_GLIGAR_x] = 0,
    [SPECIES_x_WOOPER_x] = 0,
    [SPECIES_EGG] = 1,
};
